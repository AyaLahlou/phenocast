...
if __name__ == "__main__":
    ...
    data_d='../../../glab_new/users/al4385/data/TFT_30/'
    data_directory = '../../../glab_new/users/al4385/data/TFT_boreal/'
    weight_directory =  '../../../glab_new/users/al4385/weights/TFT_Boreal/'
    prediction_path = '../../../glab_new/users/al4385/predictions/TFT_Boreal/'

    outputname=filename.split('.')[0]
    
    #data_or = data_d+filename
    data_or = data_directory+filename
    ...
    weights = weight_directory+'weights_'+outputname+'.pth'
    file_path = prediction_path+'pred_'+outputname+'.pkl'
